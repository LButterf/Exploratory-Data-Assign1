...
with(subpower_con, {
  plot(subpower_con$Time, as.numeric(as.character(subpower_con$Global_active_power)), type = "1", xlab ="", ylab = "Global Active Power")
  plot(subpower_con$Time, as.numeric(as.character(subpower_con$Voltage)), type = "1", xlab = "datetime", ylab = "Voltage")
  ...
  plot(subpower_con$Time, as.numeric(as.character(subpower_con$Global_reactive_power)), type = "1", xlab = "datetime", ylab = "Global_reactive_power")
